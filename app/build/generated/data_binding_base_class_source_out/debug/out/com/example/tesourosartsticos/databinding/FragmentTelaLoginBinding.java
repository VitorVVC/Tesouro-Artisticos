...
public final class FragmentTelaLoginBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentTelaLoginBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static FragmentTelaLoginBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentTelaLoginBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_tela_login, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentTelaLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTelaLoginBinding((FrameLayout) rootView, inputName, loginButton, logoLogin,
