...
public final class TelaLoginBinding implements ViewBinding {
  ...
  private TelaLoginBinding(@NonNull ConstraintLayout rootView, @NonNull TextInputEditText inputName,
      @NonNull Button loginButton, @NonNull ImageView logoLogin, @NonNull EditText senhaInput,
      @NonNull TextView senhaInputText, @NonNull TextInputLayout textInputLayout,
      @NonNull TextView userInputText) {
  ...
  @NonNull
  public static TelaLoginBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static TelaLoginBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.tela_login, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static TelaLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TelaLoginBinding((ConstraintLayout) rootView, inputName, loginButton, logoLogin,
          senhaInput, senhaInputText, textInputLayout, userInputText);
    }
